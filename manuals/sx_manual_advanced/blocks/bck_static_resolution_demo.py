...
sx.set_static_sources([
    ...
    str(Path(__file__).parent.parent / "sx_manuals_shared-blocks" / "static"),  # Shared static
])
""")
    st_space("v", 1)
...
#   2. /abs/path/to/sx_manuals_shared-blocks/static/data/trainers.json  -> found? return it
...
# Used in sx_manual_advanced/book.py

sx.set_static_sources([
    str(Path(__file__).parent / "static"),                                  # Project images
    str(Path(__file__).parent.parent / "sx_manuals_shared-blocks" / "static"), # Shared images
])
...
shared_blocks_path = str(Path(__file__).parent.parent / "sx_manuals_shared-blocks" / "blocks")
...
# -> ['abs/path/to/static', '/abs/path/to/sx_manuals_shared-blocks/static']
