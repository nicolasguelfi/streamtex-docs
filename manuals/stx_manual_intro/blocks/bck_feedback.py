...
def build():
    ...
    with st_list(list_type="ol") as l:
        ...
        with l.item(): st_write(bs.body, "The ", (s.bold, "command you ran"), " (e.g. stx project new, /stx-block:init, stx run)")
...
""", language="text", line_numbers=False)
    ...
    with st_block(s.project.containers.good_callout):
        ...
        with st_list(list_type="ul") as l:
            ...
            with l.item(): st_write(bs.body, (s.bold, "Documentation"), " — docs.streamtex.org")
    st_space("v", 1)
