"""Deployment manual styles. Extends StxStyles with a deployment-focused palette.

Usage in blocks:
    from custom.styles import Styles as s
    st_write(s.project.colors.primary_blue, "Hello")
    st_write(s.project.titles.course_title, "StreamTeX Deployment")
"""
...
class BackgroundsCustom:
    """Deployment manual background colors for callout containers."""
...
class ContainerStylesCustom:
    """Deployment manual callout container styles."""
