...
def build():
    with st_block(s.center_txt):
        ...
        show_code(file="examples/container/bg_colors_basic.py")
        st_space("v", 1)
        ...
        show_code(file="examples/container/paddings_predefined.py")
        st_space("v", 1)
        ...
        show_code(file="examples/container/margins_predefined.py")
        st_space("v", 1)
        ...
        show_code(file="examples/container/borders_basic.py")
        st_space("v", 1)
        ...
        show_code(file="examples/container/flex_utilities.py", line_numbers=False)
        st_space("v", 2)
        ...
        show_code(file="examples/container/layouts_precomposed.py", line_numbers=False)
        st_space("v", 1)
        ...
        show_code(file="examples/container/sizes_utilities.py", line_numbers=False)
