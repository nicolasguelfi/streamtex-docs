...
def build():
    with st_block(s.center_txt):
        ...
        show_code(file="examples/list/lists_unordered.py")
        st_space("v", 1)
        ...
        show_code(file="examples/list/lists_ordered.py")
        st_space("v", 1)
        ...
        show_code(file="examples/list/lists_nested.py")
        st_space("v", 1)
        ...
        show_code(file="examples/list/lists_custom_symbols.py")
        st_space("v", 1)
        ...
        show_code(file="examples/list/lists_ordered_lowercase.py")
        st_space("v", 1)
        ...
        show_code(file="examples/list/lists_per_item_style.py")
        st_space("v", 1)
