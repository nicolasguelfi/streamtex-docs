...
def build():
    with st_block(s.center_txt):
        ...
        show_code(file="examples/grid/basics_integer_cols.py")
        st_space("v", 1)
        ...
        show_code(file="examples/grid/basics_string_cols.py")
        st_space("v", 1)
        ...
        show_code(file="examples/grid/basics_grid_style.py")
        st_space("v", 1)
